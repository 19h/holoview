//! Native map controls and optional rendering diagnostics.
        ...
        .show(ctx, |ui| {
            if let Some(scene) = scene {
                ...
                ui.collapsing("Performance", |ui| {
                    ...
                    ui.monospace(format!("Point cache {:.1} / {:.0} MiB", scene.stats.gpu_bytes as f64 / 1048576.0, scene.config.gpu_bytes as f64 / 1048576.0));
    ...
    egui::Area::new("navigation_help".into())
        ...
        .show(ctx, |ui| {
            egui::Frame::dark_canvas(ui.style()).rounding(6.0).show(ui, |ui| {
                ui.label("Drag / WASD / arrows: pan   ·   Cmd/Ctrl/right/middle-drag / Q E: orbit   ·   R F: tilt   ·   Scroll / + −: zoom   ·   Shift: faster");
            });
        });
    action
}
